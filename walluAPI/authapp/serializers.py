...
class UserCreateSerializer(UserCreateSerializer):
    class Meta(UserCreateSerializer.Meta):
        model = User
        fields = ('id','last_login','is_superuser','username','password','first_name','last_name','is_staff','is_active','date_joined','email','blocage','profil','statut','alias','phone','dateNaissance','description','photo','localite')
